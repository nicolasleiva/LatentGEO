            ...
            <Card key={sug.id} className="glass-card flex flex-col">
              <CardHeader>
                <div className="flex flex-wrap justify-between items-start gap-2">
                  <Badge
                    variant={
                      sug.priority === "high" || sug.priority === "critical"
                        ? "destructive"
                        : "secondary"
                    }
                  >
                ...
                <CardTitle className="mt-2 text-xl">
                  {sug.suggestion_type === "new_content" && (
                    <FileText className="inline mr-2 h-5 w-5 text-brand" />
                  )}
                  {sug.suggestion_type === "faq" && (
                    <HelpCircle className="inline mr-2 h-5 w-5 text-amber-500" />
                  )}
                  {sug.content_outline?.title ||
                    sug.content_outline?.question ||
                    sug.topic}
                </CardTitle>
              ...
              <CardContent className="flex-grow space-y-3">
                ...
                {!["new_content", "faq"].includes(sug.suggestion_type) &&
                  sug.content_outline && (
