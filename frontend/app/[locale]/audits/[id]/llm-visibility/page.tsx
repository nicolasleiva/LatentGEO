        ...
        <Card className="glass-card">
          ...
          <CardContent className="space-y-4">
            ...
            >
              {loading ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" /> Checking AI
                  Models...
                </>
              ) : (
                <>
                  <Search className="mr-2 h-4 w-4" /> Check Visibility
                </>
              )}
            </Button>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2 flex-wrap">
                      {result.is_visible ? (
                        <Badge
                          variant="outline"
                          className="bg-brand text-brand-foreground border-brand"
                        >
