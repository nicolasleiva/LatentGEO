  ...
  async function handleResearch() {
    ...
    try {
      ...
      setError(
        e instanceof Error
          ? e.message
          : "Failed to research keywords. Ensure Kimi/NVIDIA key is set.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-8">
        <div className="flex justify-between items-center animate-fade-up">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Discover high-intent keywords using AI analysis of your niche.
            </p>
          </div>
        </div>
        ...
        <Card className="glass-card">
          <CardHeader>
            ...
            <CardDescription>
              Enter seeds to guide the AI, or leave empty for broad discovery.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            >
              {loading ? (
                ...
                <>
                  <Search className="mr-2 h-4 w-4" /> Find Keywords
                </>
              )}
            </Button>
                  ...
                  <TableRow key={kw.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={
                          kw.intent.toLowerCase().includes("commercial")
                            ? "bg-brand/10 text-brand border-brand/20"
                            : kw.intent.toLowerCase().includes("transactional")
