    ...
    items: [
      {
        ...
        description:
          "Learn what Generative Engine Optimization is and why it matters",
        href: "#intro",
      },
      {
        title: "Quick Start Guide",
        description: "Get your first audit running in minutes",
        href: "#quickstart",
      },
      {
        title: "Understanding Your GEO Score",
        description: "How we calculate and what it means",
        href: "#score",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Deep dive into SEO and GEO analysis",
        href: "#auditing",
      },
      {
    ...
    items: [
      {
        ...
        description: "Automatically fix issues in your codebase",
        href: "#github",
      },
      {
        title: "HubSpot Integration",
        description: "Connect your landing pages",
        href: "#hubspot",
      },
      {
        title: "API Reference",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "How AI models see your brand",
        href: "#llm",
      },
      {
        title: "Schema Markup",
        description: "Structured data optimization",
        href: "#schema",
      },
    ],
  },
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Everything you need to optimize your website for the age of
        ...
        <div className="mt-16 space-y-16">
          <section id="intro" className="scroll-mt-24">
            ...
            <div className="prose max-w-none max-w-none">
              ...
              <p className="text-foreground/80 leading-relaxed mt-4">
                Unlike traditional SEO which focuses on ranking in search
                results, GEO ensures your brand, products, and services are
                correctly understood and recommended by AI systems when users
                ask questions.
              </p>
              <div className="mt-6 p-4 bg-brand/10 border border-brand/20 rounded-xl">
                ...
                <p className="text-foreground/80 mt-2">
                  Studies show that 43% of consumers are already using AI
                  assistants for product research. If your content is not
                  optimized for GEO, you are invisible to nearly half of
                  potential customers.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 bg-background/70 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Go to the homepage and paste your website URL in the search
                    bar.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-4 bg-background/70 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Our AI crawls your site, analyzes content, and compares with
                    competitors.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-4 bg-background/70 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Get actionable insights and a prioritized fix plan to
              ...
              <div className="flex gap-4 p-4 bg-background/70 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Connect your repository and let AI automatically create pull
                    requests with fixes.
                  </p>
                </div>
              </div>
          ...
          <section id="score" className="scroll-mt-24">
            ...
            <p className="text-foreground/80 mb-6">
              Your GEO Score is calculated from multiple factors that influence
              how AI systems understand and represent your content:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-background/70 rounded-xl">
                ...
                <p className="text-muted-foreground text-sm">
                  Clear, authoritative content with proper structure and
                  headings.
                </p>
              </div>
              <div className="p-4 bg-background/70 rounded-xl">
