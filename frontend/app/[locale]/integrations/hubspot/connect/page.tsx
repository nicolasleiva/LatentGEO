...
export default function HubSpotConnect() {
    ...
    const handleConnect = async () => {
        setLoading(true)
        try {
            const response = await fetchWithBackendAuth(`${API_URL}/api/hubspot/auth-url`)
        ...
        <div className="container mx-auto py-20 flex justify-center">
            <Card className="w-full max-w-md">
                <CardHeader>
                    ...
                    <CardDescription>
                        Connect your HubSpot portal to audit and optimize your pages automatically.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex flex-col gap-4">
                        <div className="bg-orange-50 p-4 rounded-md border border-orange-100">
                            <h3 className="font-medium text-orange-800 mb-2">Features enabled:</h3>
