  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-8">
      <nav className="flex items-center gap-4 mb-12 max-w-7xl mx-auto">
        <Button variant="ghost" onClick={() => router.push('/')} className="text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-full px-4">
          <ArrowLeft className="h-4 w-4 mr-2" /> Back
        </Button>
        <div className="h-6 w-px bg-border"></div>
        <span className="text-muted-foreground text-sm">Content Intelligence</span>
      </nav>
      ...
      <main className="max-w-7xl mx-auto">
        <div className="glass-card p-8 md:p-10">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Deep dive into keyword gaps, content issues, and duplication.</p>
          </div>

          <Tabs defaultValue="keywords" className="space-y-8">
            <TabsList className="inline-flex w-fit">
              <TabsTrigger value="keywords" className="rounded-full px-6 flex items-center gap-2">
                <BarChart2 className="w-4 h-4" /> Keyword Gap
              </TabsTrigger>
              <TabsTrigger value="heatmap" className="rounded-full px-6 flex items-center gap-2">
                <Layers className="w-4 h-4" /> Issues Heatmap
              </TabsTrigger>
              <TabsTrigger value="duplicates" className="rounded-full px-6 flex items-center gap-2">
