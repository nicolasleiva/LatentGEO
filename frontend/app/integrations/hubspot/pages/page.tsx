        ...
        <div className="container mx-auto py-8">
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-3">
                    ...
                    <Button onClick={handleAudit} disabled={selected.size === 0 || auditing}>
            ...
            <div className="grid gap-4">
                {pages.map(page => (
                    <Card key={page.id} className={selected.has(page.id) ? 'border-primary' : ''}>
                        <CardContent className="p-4 flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href={page.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary">
                            ...
                            <div className="text-sm text-muted-foreground">
                                Last synced: {new Date(page.last_synced_at).toLocaleDateString()}
                            </div>
                        </CardContent>
                    </Card>
                ))}
