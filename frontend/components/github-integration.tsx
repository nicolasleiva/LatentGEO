  ...
  const createAutoFixPR = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setPrResult({
          success: false,
          error: data.detail || "Error creating PR",
        });
      }
    } catch (err: any) {
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mb-4">
              Connect your GitHub account to automatically create Pull Requests
              with AI-powered SEO/GEO fixes.
            </p>
            <Button
    ...
    <Card className="glass-card p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mb-4">
            Create a Pull Request with AI-generated fixes for all detected
            SEO/GEO issues.
          </p>
                ...
                {prResult.success ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground/70 text-sm">
                      ...
                      {prResult.data.fixes_applied} fixes
                    </p>
