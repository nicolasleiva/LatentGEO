...
export function HubSpotIntegration({ auditId, auditUrl }: HubSpotIntegrationProps) {
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                    ...
                    <div className="space-y-4">
                        {/* Connection Selector */}
                        <div>
                            <label className="text-sm text-muted-foreground mb-2 block">HubSpot Portal</label>
                            <select
                        ...
                        {loading && !pages.length ? (
                            ...
                            <div>
                                <label className="text-sm text-muted-foreground mb-2 block">HubSpot Page</label>
                                <select
                                    value={selectedPage || ''}
                            ...
                            <div className="bg-muted/50 p-4 rounded-xl border border-border">
                                ...
                                <div className="space-y-2 max-h-48 overflow-y-auto">
                                    {recommendations.map((rec) => (
                                        <div key={rec.id} className="text-xs bg-background/50 p-2 rounded border border-border">
                        ...
                        >
                            {applying ? (
                                ...
                                <>
                                    <Sparkles className="h-4 w-4 mr-2" />
                                    Apply {recommendations.length} Recommendation{recommendations.length !== 1 ? 's' : ''}
                                </>
                            )}
                        </Button>
