...
def upgrade():
    ...
    op.create_index(op.f('ix_citation_tracking_tracked_at'), 'citation_tracking', ['tracked_at'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_citation_tracking_tracked_at'), table_name='citation_tracking')
