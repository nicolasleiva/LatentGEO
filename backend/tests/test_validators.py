...
class TestURLInputValidator:
    ...
    def test_localhost_blocked(self):
        ...
        assert "internas" in str(exc_info.value).lower() or "ssrf" in str(exc_info.value).lower()
...
class TestAPIKeyInputValidator:
    ...
    def test_valid_api_key(self):
        ...
        input_data = APIKeyInput(api_key="sk-AbCdEfGhIjKlMnOpQrStUvWxYz12345678901234")
        assert input_data.api_key == "sk-AbCdEfGhIjKlMnOpQrStUvWxYz12345678901234"
...
class TestPasswordInputValidator:
    ...
    def test_common_password_rejected(self):
        ...
        weak_passwords = [
            # Note: these need to pass the other checks to reach the common password check
            # So we use variants that meet all requirements
        ]
...
class TestAuditRequestInputValidator:
    ...
    def test_market_sanitized(self):
        ...
        input_data = AuditRequestInput(
            url="https://example.com",
            market='<script>alert("xss")</script>us'
        )
