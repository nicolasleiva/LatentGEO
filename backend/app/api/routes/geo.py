...
async def analyze_commerce_query(
    ...
    try:
        ...
        return {
            ...
            "site_root_summary": payload.get("site_root_summary", {}),
            "product_intelligence": payload.get("product_intelligence", {}),
            "root_cause_summary": payload.get("root_cause_summary", []),
            "search_engine_fixes": payload.get("search_engine_fixes", []),
            "merchandising_fixes": payload.get("merchandising_fixes", []),
            "technical_watchouts": payload.get("technical_watchouts", []),
