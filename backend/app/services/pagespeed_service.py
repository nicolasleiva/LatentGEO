...
class PageSpeedService:
    ...
    async def analyze_url(
        url: str, api_key: Optional[str] = None, strategy: str = "mobile"
    ) -> Dict:
        ...
        if not api_key:
            ...
            raise ValueError(
                "GOOGLE_PAGESPEED_API_KEY is required for real analysis. Mock data is disabled."
            )
        ...
        for attempt in range(max_retries):
            try:
                logger.info(
                    f"PageSpeed API call attempt {attempt+1}/{max_retries} for {url} ({strategy})"
                )
                    ...
                    if status_code == 200:
                        ...
                        return {
                                ...
                                "metadata": {
                                    ...
                                    "lighthouse_version": environment.get(
                                        "lighthouseVersion"
                                    ),
                                    "network_throttling": environment.get(
                                        "networkUserAgent"
                                    ),
                                    "benchmark_index": environment.get(
                                        "benchmarkIndex"
                                    ),
                                },
                                ...
                                "opportunities": {
                                    "uses_long_cache_ttl": get_audit_data(
                                        "uses-long-cache-ttl"
                                    ),
                                    "uses_optimized_images": get_audit_data(
                                        "uses-optimized-images"
                                    ),
                                    "uses_responsive_images": get_audit_data(
                                        "uses-responsive-images"
                                    ),
                                    "modern_image_formats": get_audit_data(
                                        "modern-image-formats"
                                    ),
                                    "offscreen_images": get_audit_data(
                                        "offscreen-images"
                                    ),
                                    "font_display": get_audit_data("font-display"),
                                    "render_blocking_resources": get_audit_data(
                                        "render-blocking-resources"
                                    ),
                                    "server_response_time": get_audit_data(
                                        "server-response-time"
                                    ),
                                    "redirects": get_audit_data("redirects"),
                                    "uses_rel_preconnect": get_audit_data(
                                        "uses-rel-preconnect"
                                    ),
                                    "uses_rel_preload": get_audit_data(
                                        "uses-rel-preload"
                                    ),
                                    "critical_request_chains": get_audit_data(
                                        "critical-request-chains"
                                    ),
                                    "network_rtt": get_audit_data("network-rtt"),
                                    "network_server_latency": get_audit_data(
                                        "network-server-latency"
                                    ),
                                    "lcp_lazy_loaded": get_audit_data(
                                        "lcp-lazy-loaded"
                                    ),
                                    "largest_contentful_paint_element": get_audit_data(
                                        "largest-contentful-paint-element"
                                    ),
                                    "layout_shift_elements": get_audit_data(
                                        "layout-shift-elements"
                                    ),
                                    "duplicated_javascript": get_audit_data(
                                        "duplicated-javascript"
                                    ),
                                    "legacy_javascript": get_audit_data(
                                        "legacy-javascript"
                                    ),
                                    "third_party_summary": get_audit_data(
                                        "third-party-summary"
                                    ),
                                    "third_party_facades": get_audit_data(
                                        "third-party-facades"
                                    ),
                                },
                                "diagnostics": {
                                    "unused_javascript": get_audit_data(
                                        "unused-javascript"
                                    ),
                                    "unused_css_rules": get_audit_data(
                                        "unused-css-rules"
                                    ),
                                    "unsized_images": get_audit_data("unsized-images"),
                                    "total_byte_weight": get_audit_data(
                                        "total-byte-weight"
                                    ),
                                    "long_tasks": get_audit_data("long-tasks"),
                                    "dom_size": get_audit_data("dom-size"),
                                    "bootup_time": get_audit_data("bootup-time"),
                                    "mainthread_work_breakdown": get_audit_data(
                                        "mainthread-work-breakdown"
                                    ),
                                    "duplicated_javascript": get_audit_data(
                                        "duplicated-javascript"
                                    ),
                                    "uses_passive_event_listeners": get_audit_data(
                                        "uses-passive-event-listeners"
                                    ),
                                    "no_document_write": get_audit_data(
                                        "no-document-write"
                                    ),
                                    "efficient_animated_content": get_audit_data(
                                        "efficient-animated-content"
                                    ),
                                    "non_composited_animations": get_audit_data(
                                    ...
                                    "resource_summary": get_audit_data(
                                        "resource-summary"
                                    ),
                                    "network_requests": get_audit_data(
                                        "network-requests"
                                    ),
                                },
                                "accessibility": {
                                    "score": get_score("accessibility"),
                                    "aria_allowed_attr": get_audit_data(
                                        "aria-allowed-attr"
                                    ),
                                    "aria_required_attr": get_audit_data(
                                        "aria-required-attr"
                                    ),
                                    "aria_valid_attr_value": get_audit_data(
                                        "aria-valid-attr-value"
                                    ),
                                    "aria_valid_attr": get_audit_data(
                                        "aria-valid-attr"
                                    ),
                                    ...
                                    "duplicate_id_active": get_audit_data(
                                        "duplicate-id-active"
                                    ),
                                    "duplicate_id_aria": get_audit_data(
                                        "duplicate-id-aria"
                                    ),
                                    "form_field_multiple_labels": get_audit_data(
                                    ...
                                    "html_lang_valid": get_audit_data(
                                        "html-lang-valid"
                                    ),
                                    "image_alt": get_audit_data("image-alt"),
                                    "input_image_alt": get_audit_data(
                                        "input-image-alt"
                                    ),
                                    ...
                                    "td_headers_attr": get_audit_data(
                                        "td-headers-attr"
                                    ),
                                    "th_has_data_cells": get_audit_data(
                                        "th-has-data-cells"
                                    ),
                                ...
                                "seo": {
                                    ...
                                    "viewport": get_audit_data("viewport"),
                                    "document_title": get_audit_data("document-title"),
                                    "meta_description": get_audit_data(
                                        "meta-description"
                                    ),
                                    "http_status_code": get_audit_data(
                                        "http-status-code"
                                    ),
                                    "link_text": get_audit_data("link-text"),
                                    "crawlable_anchors": get_audit_data(
                                        "crawlable-anchors"
                                    ),
                                ...
                                "best_practices": {
                                    ...
                                    "errors_in_console": get_audit_data(
                                        "errors-in-console"
                                    ),
                                    "image_aspect_ratio": get_audit_data(
                                        "image-aspect-ratio"
                                    ),
                                    "image_size_responsive": get_audit_data(
                                    ...
                                    "geolocation_on_start": get_audit_data(
