...
async def example_usage():
    ...
    token = "your-hubspot-access-token-here"
    ...
    try:
        ...
        for page in pages[:5]:  # Solo las primeras 5
            ...
            if not page.meta_description or len(page.meta_description) < 50:
                print(f"   ⚠️  Meta description faltante o muy corta")
                
                # 5. Generar nueva meta description (aquí usarías tu LLM)
                new_meta = f"Descubre {page.name} - Información completa y optimizada para SEO"
