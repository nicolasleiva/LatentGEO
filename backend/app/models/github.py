...
class GitHubConnection(Base):
    ...
    repositories = relationship("GitHubRepository", back_populates="connection", cascade="all, delete-orphan")
...
class GitHubRepository(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    connection_id = Column(String(36), ForeignKey("github_connections.id"), nullable=False)
...
class GitHubPullRequest(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    repository_id = Column(String(36), ForeignKey("github_repositories.id"), nullable=False)
...
class GitHubWebhookEvent(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    repository_id = Column(String(36), ForeignKey("github_repositories.id"), nullable=True)
